...
package deemiensa.com.learnhub.businessobjects.db;
...
import deemiensa.com.learnhub.businessobjects.interfaces.OrderableDatabase;
...
public class BookmarksDb extends SQLiteOpenHelperEx implements OrderableDatabase {
	 ...
	 *
	 * @param video HomeVideo to remove.
	 *
	...
	/**
	 * When a HomeVideo in the Bookmarks tab is drag & dropped to a new position, this will be
	...
	/**
	 * Check if the specified HomeVideo has been bookmarked.
	 *
	 * @param video HomeVideo to check
	 *
	...
	/**
	 * Add a Listener that will be notified when a HomeVideo is added or removed from Bookmarked Videos. This will
	 * allow the HomeVideo Grid to be redrawn in order to remove the video from display.
	 *
