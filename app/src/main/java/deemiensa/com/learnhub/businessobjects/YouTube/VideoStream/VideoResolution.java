...
package deemiensa.com.learnhub.businessobjects.YouTube.VideoStream;

/**
 * HomeVideo resolution (e.g. 1080p).
 */
public enum VideoResolution {
	 ...
	 *
	 * @param resIdString HomeVideo resolution ID
