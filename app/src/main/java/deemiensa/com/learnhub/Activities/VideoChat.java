...
public class VideoChat extends AppCompatActivity implements Session.SessionListener, PublisherKit.PublisherListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRingingSound = MediaPlayer.create(VideoChat.this, R.raw.ringing_sound);
                ...
                null, new Response.Listener<JSONObject>()
        {
            ...
            public void onResponse(JSONObject response)
            {
                try
                {
                    ...
                    mSession = new Session.Builder(VideoChat.this, API_KEY, SESSION_ID).build();
        ...
        if(mCurrentUserId != null)
        {
            ...
            mVideoSessionDataBase.updateChildren(videoSessionDataBaseMap, new DatabaseReference.CompletionListener()
            {
                ...
                public void onComplete(@Nullable DatabaseError databaseError, @NonNull DatabaseReference databaseReference)
                {
                    ...
                    {
                        Toast.makeText(VideoChat.this, "Error updating data base", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
