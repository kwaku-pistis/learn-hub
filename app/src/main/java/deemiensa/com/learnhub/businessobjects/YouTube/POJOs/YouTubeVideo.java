...
import deemiensa.com.learnhub.BuildConfig;
import deemiensa.com.learnhub.R;
import deemiensa.com.learnhub.businessobjects.FileDownloader;
import deemiensa.com.learnhub.businessobjects.Logger;
import deemiensa.com.learnhub.businessobjects.YouTube.Tasks.GetVideoStreamTask;
import deemiensa.com.learnhub.businessobjects.YouTube.VideoStream.StreamMetaData;
import deemiensa.com.learnhub.businessobjects.db.BookmarksDb;
...
import static deemiensa.com.learnhub.App.SkyTubeApp.getContext;
import static deemiensa.com.learnhub.App.SkyTubeApp.getStr;
...
public class YouTubeVideo implements Serializable {
	...
	/**
	 * HomeVideo duration string (e.g. "5:15").
	 */
	private String duration;
	/**
	 *  HomeVideo duration in seconds
	 */
	...
	public void shareVideo(Context context) {
		...
		intent.putExtra(Intent.EXTRA_TEXT, getVideoUrl());
		context.startActivity(Intent.createChooser(intent, context.getString(R.string.share_via)));
	}

	public void copyUrl(Context context) {
		ClipboardManager clipboard = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
		ClipData clip = ClipData.newPlainText("HomeVideo URL", getVideoUrl());
	...
	/**
	 * Get the Uri for the local copy of this HomeVideo.
	 *
	 * @return Uri
	 */
